...
public class ProtectorDragon implements SkyblockEntity, Defensive {
    ...
    public void spawn(Location loc) {
        entity = loc.getWorld().spawn(loc, EnderDragon.class, enderDragon -> {
            enderDragon.getAttribute(Attribute.GENERIC_FLYING_SPEED).setBaseValue(1.4);
    ...
    public void updateNameTag() {
        entity.setCustomName("§8Protector Dragon");
    }
