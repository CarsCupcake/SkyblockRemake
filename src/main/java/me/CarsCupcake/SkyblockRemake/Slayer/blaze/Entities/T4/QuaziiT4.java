...
public class QuaziiT4 extends SkyblockEntity implements Demons, FinalDamageDesider {
                    ...
                    if (i > 10)
                        for (double d = 0.3; d < 10; d += 0.3) {
                            ...
                            e.forEach(b -> {
                                ...
                                c.entityToPlayerDamage(QuaziiT4.this, player, new Bundle<>(0, (int) (Main.getPlayerStat(SkyblockPlayer.getSkyblockPlayer((Player) b), Stats.Health) * 0.7)));
