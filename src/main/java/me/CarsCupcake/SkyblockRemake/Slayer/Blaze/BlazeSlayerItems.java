...
public class BlazeSlayerItems {
    public BlazeSlayerItems(){
        ...
        manager.addAbility(new AshenAuricSwap(), AbilityType.RightClick, "Attunement", lore,0, 0);
        ...
        manager.setStat(Stats.Strength, 45);
        manager.setStat(Stats.CritDamage, 15);
        manager.addAbility(new SpiritCystalSwap(), AbilityType.RightClick, "Attunement", lore,0, 0);
