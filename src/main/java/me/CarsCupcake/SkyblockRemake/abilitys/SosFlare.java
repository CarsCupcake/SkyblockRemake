...
public class SosFlare implements Deployable {
    ...
    public boolean executeAbility(PlayerInteractEvent event) {
        ...
        firework = event.getPlayer().getLocation().getWorld().spawn(event.getPlayer().getLocation(), Firework.class, f->{
           ...
           meta.setPower(1);
           meta.addEffect(FireworkEffect.builder().withColor(Color.PURPLE).withTrail().with(FireworkEffect.Type.STAR).build());
    ...
    public void start(Location loc){
        ...
        stand = loc.getWorld().spawn(loc, ArmorStand.class,s ->{
            ...
            s.setGravity(false);
            s.getEquipment().setHelmet(Tools.CustomHeadTexture("https://textures.minecraft.net/texture/c0062cc98ebda72a6a4b89783adcef2815b483a01d73ea87b3df76072a89d13b"));
        });
    }
