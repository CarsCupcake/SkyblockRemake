...
public class ProtectiveBlood implements FullSetBonus, Listener {
    ...
    public void onDefensItem(GetStatFromItemEvent event) {
        if (event.getStat() != Stats.Defense) return;
        if (event.getPlayer() == null) return;
        if (!actives.contains(event.getPlayer())) return;
    ...
    private static ItemManager protectorDragonFragment() {
        return new ItemManager("Protector Dragon Fragment", "PROTECTOR_FRAGMENT", ItemType.Non, null, null, null, null, 0, 0, 0, 0, ItemRarity.EPIC, "https://textures.minecraft.net/texture/48de339af63a229c9238d027e47f53eeb56141a419f51b35c31ea1494b435dd3", UUID.fromString("86541f16-3bdf-4d08-871a-dcdf8ba373f5"));
    }
    ...
    private static ItemManager protectorHelmet() {
        ...
        ItemManager manager = new ItemManager("Protector Dragon Helmet", "PROTECTOR_DRAGON_HELMET", ItemType.Helmet, null, "Protective Blood", null, null, 0, 0, 0, 0, ItemRarity.LEGENDARY, "https://textures.minecraft.net/texture/f37a596cdc4b11a9948ffa38c2aa3c6942ef449eb0a3982281d3a5b5a14ef6ae");
    ...
    private static ItemManager protectorChestplate() {
        ...
        abilityLore.add("§aDefense §7for each missing");
        abilityLore.add("§7percent of HP.");
        ItemManager manager = new ItemManager("Protector Dragon Chestplate", "PROTECTOR_DRAGON_CHESTPLATE", ItemType.Chestplate, null, "Protective Blood", null, null, 0, 0, 0, 0, Material.LEATHER_CHESTPLATE, Color.fromRGB(0x99978B), ItemRarity.LEGENDARY);
        manager.setNpcSellPrice(100000);
    ...
    private static ItemManager protectorLeggings() {
        ...
        abilityLore.add("§aDefense §7for each missing");
        abilityLore.add("§7percent of HP.");
        ItemManager manager = new ItemManager("Protector Dragon Leggings", "PROTECTOR_DRAGON_LEGGINGS", ItemType.Leggings, null, "Protective Blood", null, null, 0, 0, 0, 0, Material.LEATHER_LEGGINGS, Color.fromRGB(0x99978B), ItemRarity.LEGENDARY);
        manager.setNpcSellPrice(100000);
    ...
    private static ItemManager protectorBoots() {
        ...
        abilityLore.add("§aDefense §7for each missing");
        abilityLore.add("§7percent of HP.");
        ItemManager manager = new ItemManager("Protector Dragon Boots", "PROTECTOR_DRAGON_BOOTS", ItemType.Boots, null, "Protective Blood", null, null, 0, 0, 0, 0, Material.LEATHER_BOOTS, Color.fromRGB(0x99978B), ItemRarity.LEGENDARY);
        manager.setNpcSellPrice(100000);
        manager.setStat(Stats.Health, 100);
        manager.setStat(Stats.Defense, 165);
        manager.addSlot(new GemstoneSlot(SlotType.Amethyst));
