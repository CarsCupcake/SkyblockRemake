...
public class AlertFlare implements Deployable {
    ...
    public boolean executeAbility(PlayerInteractEvent event) {
        ...
        firework = event.getPlayer().getLocation().getWorld().spawn(event.getPlayer().getLocation(), Firework.class, f->{
           ...
           meta.setPower(1);
           meta.addEffect(FireworkEffect.builder().withColor(Color.BLUE).withTrail().with(FireworkEffect.Type.BURST).build());
    ...
    public void start(Location loc){
        ...
        stand = loc.getWorld().spawn(loc, ArmorStand.class,s ->{
            ...
            s.setGravity(false);
            s.getEquipment().setHelmet(Tools.CustomHeadTexture("https://textures.minecraft.net/texture/9d2bf9864720d87fd06b84efa80b795c48ed539b16523c3b1f1990b40c003f6b"));
        });
    }
