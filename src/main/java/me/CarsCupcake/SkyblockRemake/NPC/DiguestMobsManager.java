...
public class DiguestMobsManager implements Listener {
	...
	public static void createEntity(Entity entity, String name, String texture, String signature) {
		...
		EntityPlayer temp = new EntityPlayer(((CraftServer)Bukkit.getServer()).getServer(), ((CraftWorld)entity.getWorld()).getHandle(), profiel);
