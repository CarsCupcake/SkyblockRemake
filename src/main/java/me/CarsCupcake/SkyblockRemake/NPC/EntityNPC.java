    ...
    public static void loadNPC() {
        ...
        if (file.get().getConfigurationSection("data") != null)
            file.get().getConfigurationSection("data").getKeys(false).forEach(var -> {
                Location loc = new Location(Bukkit.getWorld(file.get().getString("data." + var + ".world")), file.get().getDouble("data." + var + ".x"), file.get().getDouble("data." + var + ".y"), file.get().getDouble("data." + var + ".z"), (float) file.get().getInt("data." + var + ".ya"), (float) file.get().getInt("data." + var + ".p"));
                try {
