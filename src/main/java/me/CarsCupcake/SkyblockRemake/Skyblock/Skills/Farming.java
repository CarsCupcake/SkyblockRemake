...
public class Farming implements Skill {
	...
	public void setXp(double xp) {
		...
		SkillsSave.reload();
		SkillsSave.get().set(player.getUniqueId() + "." +Skills.Farming.toString().toLowerCase()+".xp", xp);
		SkillsSave.save();
		SkillsSave.reload();
	...
	public void reset() {
		...
		SkillsSave.reload();
		SkillsSave.get().set(player.getUniqueId() +"."+ Skills.Farming.toString().toLowerCase() + ".xp", 0);SkillsSave.get().set(player.getUniqueId() +"." +Skills.Farming.toString().toLowerCase()+ ".level", 0);
		SkillsSave.save();
		SkillsSave.reload();
	...
	public void setLevel(int level) {
		...
		SkillsSave.reload();
		SkillsSave.get().set(player.getUniqueId() + "."+Skills.Farming.toString().toLowerCase()+".level", level);
		SkillsSave.save();
		SkillsSave.reload();
