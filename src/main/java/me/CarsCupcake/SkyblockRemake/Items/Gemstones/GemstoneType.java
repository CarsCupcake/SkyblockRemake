...
public enum GemstoneType {
    ...
    Topaz(Stats.Pristine),
    Jade(Stats.MiningFortune),
    Sapphire(Stats.Inteligence),
            ...
            switch (state) {
                case Rough: {
                    switch (rarity) {
                        ...
                        case DIVINE, MYTHIC, SPECIAL, SUPREME, VERY_SPECIAL -> {
                            return 7;
                        }
                        case EPIC -> {
                            return 4;
                ...
                case Flawed: {
                    switch (rarity) {
                        ...
                        case DIVINE, MYTHIC, SUPREME, SPECIAL, VERY_SPECIAL -> {
                            return 10;
                        }
                        case EPIC -> {
                            return 6;
                ...
                case Fine: {
                    switch (rarity) {
                        ...
                        case DIVINE, VERY_SPECIAL, SUPREME, MYTHIC, SPECIAL -> {
                            return 14;
                        }
                        case EPIC -> {
                            return 8;
            ...
            switch (state) {
                ...
                case Flawless: {
                    switch (rarity) {
                        ...
                        case DIVINE, VERY_SPECIAL, SUPREME, SPECIAL -> {
                            return 92;
                        }
                        case EPIC -> {
                            return 44;
            ...
            switch (state) {
                case Rough: {
                    switch (rarity) {
                        ...
                        case RARE, LEGENDARY, EPIC, MYTHIC -> {
                            return 0.4;
                        }
                        case DIVINE, SPECIAL, SUPREME, VERY_SPECIAL -> {
                            return 0.5;
                ...
                case Flawed: {
                    switch (rarity) {
                        ...
                        case UNCOMMON, RARE, EPIC, LEGENDARY, MYTHIC -> {
                            return 0.8;
                        }
                        case DIVINE, SPECIAL, SUPREME, VERY_SPECIAL -> {
                            return 0.9;
