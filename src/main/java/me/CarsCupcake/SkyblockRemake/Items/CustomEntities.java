...
public class CustomEntities {
	...
	public static Entity IceWalker(Location loc) {
		...
		LivingEntity entity = loc.getWorld().spawn(loc, Zombie.class, z->{
		...
		DiguestMobsManager.createEntity(entity, "",
		...
		AttributeInstance attributeSpeed = entity.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED);
	...
	public static Entity KuudraTentacle(Location loc) {
		return loc.getWorld().spawn(loc,Wither.class, z->{
