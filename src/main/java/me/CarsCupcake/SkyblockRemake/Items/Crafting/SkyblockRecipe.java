...
public abstract class SkyblockRecipe {
        ...
        for (SkyblockRecipe recipe : recipes) {
            ...
            if (recipe instanceof SkyblockShapelessRecipe shapless) {
                ...
                for (CraftingObject ingredient : ingredients)
                    ...
                    else ingredientsAmounts.put(ingredient.manager().itemID, ingredient.amount());
                ...
                for (ItemStack item : stacks) {
                    ...
                    if (!contains || object == null) {
                        ...
                        ingredientsAmount.replace(str, ingredientsAmount.get(str) - item.getAmount());
                    }
    ...
    private static boolean shaplessIsDone(HashMap<String, Integer> ingredientsAmount, HashMap<String, Integer> wanted) {
        ...
        ingredientsAmount.forEach((id, amount) -> {
            if (amount > wanted.get(id)) result.set(0, false);
        });
        return result.get(0);
    }
    ...
    public static void init() {
        ...
        objects.add(new CraftingObject(Items.SkyblockItems.get("FLAWLESS_RUBY_GEM"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get("FLAWLESS_RUBY_GEM"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get(Material.EGG.toString()), 1));
        objects.add(new CraftingObject(Items.SkyblockItems.get("FLAWLESS_RUBY_GEM"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get("FLAWLESS_RUBY_GEM"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get("FLAWLESS_RUBY_GEM"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get("FLAWLESS_RUBY_GEM"), 8));
        SkyblockShapedRecipe shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("GEMSTONE_GOLEM;COMMON"), 1);
        shapedRecipe.setRecipe(objects);
        recipes.add(shapedRecipe);

        objects = new ArrayList<>();
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("ENCHANTED_SULPHUR"), 16));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("MOLTEN_POWDER"), 8));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("MOLTEN_POWDER"), 8));
        objects.add(new CraftingObject(null, 0));
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("WARNING_FLARE"), 1);
        shapedRecipe.setRecipe(objects);
        recipes.add(shapedRecipe);

        objects = new ArrayList<>();
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("ENCHANTED_SULPHUR"), 32));
        objects.add(new CraftingObject(Items.SkyblockItems.get("INFERNO_VERTEX"), 3));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("MOLTEN_POWDER"), 64));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("INFERNO_VERTEX"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get("WARNING_FLARE"), 1));
        objects.add(new CraftingObject(null, 0));
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("ALERT_FLARE"), 1);
        shapedRecipe.setRecipe(objects);
        recipes.add(shapedRecipe);
        ...
        objects.add(new CraftingObject(Items.SkyblockItems.get("INFERNO_VERTEX"), 8));
        objects.add(new CraftingObject(Items.SkyblockItems.get("ENCHANTED_SULPHUR"), 32));
        objects.add(new CraftingObject(Items.SkyblockItems.get("INFERNO_APEX"), 1));
        objects.add(new CraftingObject(Items.SkyblockItems.get("MOLTEN_POWDER"), 64));
        objects.add(new CraftingObject(null, 0));
        objects.add(new CraftingObject(Items.SkyblockItems.get("MOLTEN_POWDER"), 64));
        objects.add(new CraftingObject(Items.SkyblockItems.get("WILSON_ENGINEERING_PLANS"), 1));
        objects.add(new CraftingObject(Items.SkyblockItems.get("ALERT_FLARE"), 1));
        objects.add(new CraftingObject(Items.SkyblockItems.get("INFERNO_VERTEX"), 8));
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("SOS_FLARE"), 1);
        shapedRecipe.setRecipe(objects);
        recipes.add(shapedRecipe);
        ...
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("NECRON_BLADE"), 1);
        ...
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("HYPERION"), 1);
        shapedRecipe.setRecipe(encoder.encode());
        ...
        encoder.setKey('s', new CraftingObject(Items.SkyblockItems.get("NECRON_BLADE"), 1));
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("VALKYRIE"), 1);
        shapedRecipe.setRecipe(encoder.encode());
        shapedRecipe.setPrio(4);
        recipes.add(shapedRecipe);
        ...
        encoder.setKey('s', new CraftingObject(Items.SkyblockItems.get("NECRON_BLADE"), 1));
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("ASTRAEA"), 1);
        shapedRecipe.setRecipe(encoder.encode());
        shapedRecipe.setPrio(4);
        recipes.add(shapedRecipe);
        ...
        encoder.setKey('s', new CraftingObject(Items.SkyblockItems.get("NECRON_BLADE"), 1));
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("SCYLLA"), 1);
        shapedRecipe.setRecipe(encoder.encode());
        shapedRecipe.setPrio(4);
        recipes.add(shapedRecipe);
        ...
        SkyblockShapelessRecipe shapelessRecipe = new SkyblockShapelessRecipe(Items.stuffedChiliPepper());
        shapelessRecipe.addIngredient(new CraftingObject(Items.chiliPepper(), 160));
        recipes.add(shapelessRecipe);

        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("PAIN_RELEASER"), 1);
        ...
        shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get("CHAD_STICK"), 1);
        encoder = new ShapeEncoder("#*#", "*&*", "#+#");
        encoder.setKey('*', new CraftingObject(Items.reaperPepper(), 1));
        ...
        while (iterator.hasNext()) {
            ...
            if (recipe instanceof ShapedRecipe sh) {
                ArrayList<CraftingObject> objects1 = new ArrayList<>();
                int layer = -1;
                for (String str : sh.getShape()) {
                    if (sh.getIngredientMap() == null) continue;
                    layer++;
                    int i = -1;
                    for (char c : str.toCharArray()) {
                        Character character = c;
                        if (c == ' ') objects1.add(new CraftingObject(null, 1));
                        else {
                            if (sh.getIngredientMap().get(character) == null) objects1.add(new CraftingObject(null, 1));
                            else
                ...
                shapedRecipe = new SkyblockShapedRecipe(Items.SkyblockItems.get(sh.getResult().getType().toString()), sh.getResult().getAmount());
                shapedRecipe.setRecipe(objects1);
                recipes.add(shapedRecipe);


            }
            if (recipe instanceof ShapelessRecipe shapelessRecipee) {
                SkyblockShapelessRecipe newShapeles = new SkyblockShapelessRecipe(Items.SkyblockItems.get(shapelessRecipee.getResult().getType().toString()));
