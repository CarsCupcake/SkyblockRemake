...
import me.CarsCupcake.SkyblockRemake.Items.Gemstones.GemState;
...
public class Items {
    ...
    private static void redBelt() {
        ...
        }, "Love", new AbilityLore(abilityLore));
    ...
    private static void ThunderboltNecklace() {
        ...
        manager.setFullSetBonus(Bonuses.StaticCharge, "Static Charge", lore, true);
    ...
    private static void magmaLordHelmet() {
        ...
        manager.setFullSetBonus(Bonuses.MagmaLordArmor, "Fireproof", lore, true);
        manager.addSlot(new GemstoneSlot(SlotType.Combat));
        manager.addSlot(new GemstoneSlot(SlotType.Combat));
        SkyblockItems.put(manager.itemID, manager);
        ShapeEncoder encoder = new ShapeEncoder("sss", "s s", "   ");
    ...
    private static void dreadlordSword() {
        ...
        manager.setDungeonItem(true);
        manager.addAbility(new DreadlordAbility(), AbilityType.RightClick, "Dreadlord", new AbilityLore(abilityLore, "%damage%", new Bundle<>(500d, 0.3)), 40, 0);
    ...
    private static void totemOfCorruption() {
        ...
        manager.addAbility(new CorruptedTotem(), AbilityType.RightClick, "Deploy", new AbilityLore(new ArrayList<>()), 200, 0);
    ...
    private static void iceSprayWand() {
        ...
        manager.setDungeonItem(true);
        manager.addAbility(new IceSprayWand(), AbilityType.RightClick, "Ice Spray", new AbilityLore(abilityLore, "%damage%", new Bundle<>(17000d, 0.1)), 50, 5);
    ...
    private static void flowerOfTruth() {
        ...
        manager.addSlot(new GemstoneSlot(SlotType.Jasper));
        manager.setDungeonItem(true);
        manager.addAbility(new FlowerOfTruth(), AbilityType.RightClick, "Heat-Seeking Rose", new AbilityLore(abilityLore), 0.1, true, 0);
        manager.setNpcSellPrice(100000);
    ...
    private static void aspectOfTheEnd() {
        ...
        manager.addSlot(new GemstoneSlot(SlotType.Sapphire));
        manager.setDungeonItem(true);
        manager.addAbility(new AspectOfTheEnd(), AbilityType.RightClick, "Transmission", new AbilityLore(abilityLore), 50, 0);
    ...
    public static class LaserBeam implements AbilityManager<PlayerInteractEvent> {
    ...
    public static void PainReleaser() {
        ...
        manager.addAbility(new ReleaseThePain(), AbilityType.RightClick, "RELEASE THE PAIN!", new AbilityLore(lore), 300, 30);
        manager.setUnstackeble(true);
        SkyblockItems.put(manager.itemID, manager);
    ...
    public static void ChadStick() {
        ...
        manager.addAbility(new ChadIncoming(), AbilityType.RightClick, "CHAD INCOMING", new AbilityLore(lore), 500, 30);
        manager.setUnstackeble(true);
        SkyblockItems.put(manager.itemID, manager);
    ...
    public static ItemManager reaperPepper() {
        ...
        manager.addAbility(new ReaperPepper(), AbilityType.RightClick, "Consume", new AbilityLore(abiliytLore), 0, 0);
        SkyblockItems.put(manager.itemID, manager);
        return manager;
    }
    ...
    public static ItemStack Hyperion() {
        ...
        manager.addSlot(new GemstoneSlot(SlotType.Combat));
        manager.setMaxStars(5);
        manager.addAbility(new Hyperion_WitherImpact(), AbilityType.RightClick, "Wither Impact", abilityLore, 300, 0);
        SkyblockItems.put(manager.itemID, manager);
        return manager.getRawItemStack();
    }
    ...
    public static ItemStack TestItem() {
        ...
        }, AbilityType.RightClick, "Test", new AbilityLore(lore), 69, 420);
...
//Ruby gemsone
    ...
    public static ItemStack RoyalPigeon() {
        ...
        manager.addAbility(new SeekTheKing(), AbilityType.RightClick, "Seek The King", 0, 5);
        SkyblockItems.put(manager.itemID, manager);
        return manager.getRawItemStack();
    ...
    public static ItemStack InsaneDisc() {
        ...
        manager.addAbility(new SeekTheKing(), AbilityType.RightClick, "Play Music", 0, 0);
        SkyblockItems.put(manager.itemID, manager);
        return manager.getRawItemStack();
    ...
    public static void CrimsonHelmet() {
        ...
        manager.setFullSetBonus(Bonuses.Dominus, "Dominus", lore, true);
        manager.setMaxStars(10);
        SkyblockItems.put(manager.itemID, manager);
    ...
    public static void TerrorHelmet() {
        ...
        manager.setFullSetBonus(Bonuses.HydraStrike, "Hydra Strike", terrorLore, true);
        manager.setMaxStars(10);
        manager.setAttributable(true);
        manager.setStat(Stats.Health, 160);
        manager.setStat(Stats.Defense, 50);
    ...
    public static void AuroraStaff() {
        ...
        manager.setStat(Stats.Inteligence, 250);
        manager.addAbility(new AuroraStaffLeftClick(), AbilityType.LeftClick, "Rune Swap", 0, 0);
        ArrayList<String> abilityLore = new ArrayList<>();
    ...
    public static void AuroraHelmet() {
        ...
        manager.setFullSetBonus(Bonuses.ArcaneVision, "Arcane Vision", auroraLore, true);
        manager.setMaxStars(10);
        manager.setAttributable(true);
        manager.setStat(Stats.Health, 160);
        manager.setStat(Stats.Defense, 50);
    ...
    public static void DumbshitSword() {
        ...
        manager.addAbility(new WhatThaFuck(), AbilityType.EntityHit, "What the F*ck", new AbilityLore(abilityLore), 0, 0);
        SkyblockItems.put(manager.itemID, manager);
    }
    ...
    public static void warningFlare() {
        ...
        manager.addAbility(new WarningFlare(), AbilityType.RightClick, "Deploy", new AbilityLore(abilityLore), 300, 0);
        manager.addBaseEnchantment(SkyblockEnchants.ENCHANT_GLINT, 1);
        SkyblockItems.put(manager.itemID, manager);
    }
    ...
    public static void alertFlare() {
        ...
        manager.addAbility(new AlertFlare(), AbilityType.RightClick, "Deploy", new AbilityLore(abilityLore), 300, 0);
        manager.addBaseEnchantment(SkyblockEnchants.ENCHANT_GLINT, 1);
        SkyblockItems.put(manager.itemID, manager);
    }
    ...
    public static void sosFlare() {
        ...
        manager.addAbility(new SosFlare(), AbilityType.RightClick, "Deploy", new AbilityLore(abilityLore), 250, 0);
        manager.addBaseEnchantment(SkyblockEnchants.ENCHANT_GLINT, 1);
        SkyblockItems.put(manager.itemID, manager);
    }
    ...
    public static void susFlare() {
        ...
        manager.addAbility(new SusFlare(), AbilityType.RightClick, "Deploy", new AbilityLore(abilityLore), 250, 0);
        manager.setEditions(true);
        manager.addBaseEnchantment(SkyblockEnchants.ENCHANT_GLINT, 1);
        SkyblockItems.put(manager.itemID, manager);
    }
    ...
    private static void craysFish() {
        ...
        manager.setDamage(100);
        manager.setStat(Stats.Strength, 100);
        manager.addAbility(new CraysFish(), AbilityType.RightClick, "Throw", new AbilityLore(abilityLore), 15, 0);
        SkyblockItems.put(manager.itemID, manager);
    ...
    private static void bonzoStaff() {
        ...
        manager.setStat(Stats.Strength, 25);
        manager.setStat(Stats.CritDamage, 50);
        manager.addAbility(new Showtime(), AbilityType.RightClick, "Showtime", 100, 0);
        SkyblockItems.put(manager.itemID, manager);
    }
