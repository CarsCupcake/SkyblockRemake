...
public class DungeonDoors {
    ...
    public static void initDoors(int x, int y) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (!currdors.isEmpty()) for (Locations loc : newDoors) {

                if (DungeonGeneration.layers.get(loc.y).get(loc.x).type == DungeonRoomsTypes.red) continue;
                if (DungeonGeneration.layers.get(loc.y).get(loc.x).type == DungeonRoomsTypes.green) continue;
                ...
                if (type == DungeonRoomsTypes.miniboss || type == DungeonRoomsTypes.puzzle || type == DungeonRoomsTypes.Trap)
                    continue;
                if (loc.y + 1 < 6) r1 = DungeonGeneration.layers.get(loc.y + 1).get(loc.x);
                if (loc.y - 1 > -1) r2 = DungeonGeneration.layers.get(loc.y - 1).get(loc.x);
                if (loc.x - 1 > -1) r3 = DungeonGeneration.layers.get(loc.y).get(loc.x - 1);
                if (loc.x + 1 < 6) r4 = DungeonGeneration.layers.get(loc.y).get(loc.x + 1);


                if (r1 != null) {

                    if (!r1.door && !(r1.base != null && r1.base.door)) {
                        if (!((r1.base != null && cr == r1.base) || (cr.base != null && cr.base == r1.base) || (r1.base != null && r1.base == cr) || (r1.base != null && r1.base == cr.base))) {
                    ...
                    } else if (!((r1.base != null && cr == r1.base) || (cr.base != null && cr.base == r1.base) || (r1.base != null && r1.base == cr) || (r1.base != null && r1.base == cr.base)))
                        currdors.add(new Locations(r1.x, r1.y));
                }
                if (r2 != null) {

                    if (r2.door == false && !(r2.base != null && r2.base.door != false)) {
                        if (!((r2.base != null && cr == r2.base) || (cr.base != null && cr.base == r2.base) || (r2.base != null && r2.base == cr) || (r2.base != null && r2.base == cr.base))) {
                    ...
                    } else if (!((r2.base != null && cr == r2.base) || (cr.base != null && cr.base == r2.base) || (r2.base != null && r2.base == cr) || (r2.base != null && r2.base == cr.base)))
                        currdors.add(new Locations(r2.x, r2.y));
                }
                if (r3 != null) {

                    if (r3.door == false && !(r3.base != null && r3.base.door != false)) {
                        if (!((r3.base != null && cr == r3.base) || (cr.base != null && cr.base == r3.base) || (r3.base != null && r3.base == cr) || (r3.base != null && r3.base == cr.base))) {
                    ...
                    } else if (!((r3.base != null && cr == r3.base) || (cr.base != null && cr.base == r3.base) || (r3.base != null && r3.base == cr) || (r3.base != null && r3.base == cr.base)))
                        currdors.add(new Locations(r3.x, r3.y));
                }
                if (r4 != null) {

                    if (r4.door == false && !(r4.base != null && r4.base.door != false)) {
                        if (!((r4.base != null && cr == r4.base) || (cr.base != null && cr.base == r4.base) || (r4.base != null && r4.base == cr) || (r4.base != null && r4.base == cr.base))) {
                    ...
                    } else if (((r4.base != null && cr == r4.base) || (cr.base != null && cr.base == r4.base) || (r4.base != null && r4.base == cr) || (r4.base != null && r4.base == cr.base)))
                        currdors.add(new Locations(r4.x, r4.y));
                }
            }
        }
