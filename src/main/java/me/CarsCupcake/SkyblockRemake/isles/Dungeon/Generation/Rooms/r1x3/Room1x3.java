...
public abstract class Room1x3 implements IRoom {
    @Override
    ...
    public Location rotationCorner(Location l, int rotation) {
        return switch (rotation){
            ...
            case 2 -> new Location(l.getWorld(), l.getX() + 92, l.getY(), l.getZ() + 30);
            case 3 -> new Location(l.getWorld(), l.getX() + 92, l.getY(), l.getZ());
            default -> l;
        };
    }
}
