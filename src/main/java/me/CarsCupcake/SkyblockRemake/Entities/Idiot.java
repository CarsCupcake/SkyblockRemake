...
public class Idiot extends DungeonMob {
    private LivingEntity entity;

    public Idiot(int floor, boolean master) {
        super(floor, master);
    }
    ...
    public void spawn(Location loc) {
        ...
        DiguestMobsManager.createEntity(entity, loc, "Idiot", "",
                "");
    ...
    private static class SBEntity extends EntitySkeleton {
        ...
        public void a(EntityLiving entityliving, float f) {
            ...
            l.getWorld().spawn(l, WitherSkull.class, skull -> skull.setShooter(e));
        }
    }
}
